...
public class Users implements Serializable {
     ...
     *
     * @param imooc_num 慕课号，类似头条号，抖音号，公众号，唯一标识，需要限制修改次数，比如终生1次，每年1次，每半年1次等，可以用于付费修改。
     */
    public void setImooc_num(String imooc_num) {
        this.imooc_num = imooc_num;
    }
