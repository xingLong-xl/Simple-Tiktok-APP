...
@RestController
public class CommentController extends BaseInfoPropertise {
    @Autowired
    ...
    public GraceJSONResult list(@RequestParam String vlogId,
        ...
        return GraceJSONResult.ok(commentService.queryVlogComments(vlogId,
                                                                    userId,
                                                                    page,
                                                                    pageSize));
    }
    ...
    public GraceJSONResult like(@RequestParam String commentId,
        ...
        // 故意犯错，bigkey
        redis.incrementHash(REDIS_VLOG_BE_LIKED_COUNTS,commentId,1);
    ...
    public GraceJSONResult unlike(@RequestParam String commentId,
                                @RequestParam String userId){
        // 故意犯错，bigkey
        redis.decrementHash(REDIS_VLOG_BE_LIKED_COUNTS,commentId,1);
