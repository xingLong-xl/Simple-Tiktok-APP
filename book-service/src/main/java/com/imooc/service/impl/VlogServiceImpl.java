...
import com.com.imooc.enums.MessageEnum;
...
@Service
public class VlogServiceImpl extends BaseInfoPropertise implements VlogService {
    @Autowired
    ...
    public PagedGridResult getIndexVlogList(String userId,
        ...
        for(IndexVlogVO v : list){
            ...
            if(StringUtils.isNotBlank(userId)) {
                ...
                v.setDoILikeThisVlog(doILikeVolg(userId,vlogId));
            }
            // 获得当前视频被点赞过的总数
    ...
    public PagedGridResult getMyFollowVlogList(String myId,
        ...
        for(IndexVlogVO v : list){
            ...
            if(StringUtils.isNotBlank(myId)) {
                ...
                v.setDoILikeThisVlog(doILikeVolg(myId, vlogId));
            }
            // 获得当前视频被点赞过的总数
            v.setLikeCounts(getVlogBeLikedCounts(vlogId));
        }
    ...
    private boolean doILikeVolg(String myId, String vlogId){
    ...
    @Override
    @Transactional
    public void changeToPrivateOrPublic(String userId, String vlogId, Integer yerOrNo) {
        ...
        pendingVlog.setIsPrivate(yerOrNo);
    ...
    public void userLikeVlog(String userId, String vlogId) {
        ...
        likedVlog.setId(rid);
        likedVlog.setVlog_id(vlogId);
        likedVlog.setUser_id(userId);
