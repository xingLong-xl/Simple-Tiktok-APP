...
@Service
public class FansServiceImpl extends BaseInfoPropertise implements FansService {
    ...
    public PagedGridResult queryMyFans(String myId,
         ...
         * 2、判断粉丝关注我，并且我也关注粉丝 -》 循环fanslist，获得每一个粉丝，再去数据库查询
         * 3、如果我也关注它，说明，我两为朋友关系，则标记flag为true，否则false.
         *
         * 高端做法：
         * 1、关注取消的时候，关联关系保存在redis中，不要依赖数据库。
         * 2、数据库查询后，直接查询redis，避免第二次循环查询数据库的尴尬局面。
         */
